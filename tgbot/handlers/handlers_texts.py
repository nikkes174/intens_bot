...
Нажимая на кнопку, Вы подтверждаете своё <a href="{LINK_CONSENT}">согласие
на обработку персональных данных</a> в соответствии с <a href="{LINK_PRIVACY_POLICY}">
...
START_TEXT = """
Мини-курс "Кэшбек на стероидах. bySviat" 

Короткий мини-курс из 7 модулей, который разложит по полочкам, как работает кэшбек и как можно максимизировать прибыль от него

Каждый модуль - отдельное видео в канале, для каждого видео есть текствоая методичка. А также доступ в закрытый канал в Telegram и доступ к чату
"""
